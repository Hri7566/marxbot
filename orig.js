...
MPP.client.on('a', msg => {
    ...
    if  (cmd == "/On") {
        ...
        if (!isBlocked) {
            ...
            if (cmd == "/help") {
                var phelp = ("Commands: /help | /test | /about | /rip | /quote | /test | /fact | /loss | /eat | /tickle | /roast | /kill | /stab | /hug | /shoot | /slap | /cuddle | /rape | /friendzone | /fight | /rps | /poke | /ranks");
                var khelp = (" | /art");
                var nhelp = (" | /clearchat | /boom | /kickban | /wave ");
                var kinghelp = (" | /on | /off");
                if (isKing) {
                    MPP.chat.send(phelp + khelp + nhelp + kinghelp);
                } else if (isNoble) {
                    MPP.chat.send(phelp + khelp + nhelp);
                } else if (isKnight) {
                    MPP.chat.send(phelp + khelp);
                } else {
                    MPP.chat.send(phelp);
                }
            } else if (cmd == "/art") {
